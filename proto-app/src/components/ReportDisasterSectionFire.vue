<template>
  <div>
    <div class="chunk">
      <div class="chunk-title">Fire Perimeter on {{ dateHeader }}</div>
    ...
    <div class="chunk">
      <div class="chunk-title">Acres Burned on {{ dateHeader }}</div>
      <ReportTable
      ...
      acresAffectedRows() {
        const generateAcresBurnedRows = (features, placeType) => {
          return features.map(feature => {
            ...
            const timeseries = this.acresAffectedTimeseriesPlaces.concat(this.acresAffectedTimeseriesCounties).find(d => d.polygon_name === feature?.properties['rm_name'])
      ...
      calculateAcresBurnedTimeseries(places) {
        ...
        const timeseries = places
          .map(feature => {
            ...
            return {
              polygon_name: feature?.properties['rm_name'],
              data: timeseries,

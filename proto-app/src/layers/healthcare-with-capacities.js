...
export const healthcareFacilitiesWithCapacitiesLayer = {
  ...
  async loadData(store, loadLabel) {
    ...
    const path = `${disasterBaseUrlData}/hhs-bed-capacity/data.csv`

    let healthcareFacilitiesWithCapacities = await helpers.fetchCsvAndBumpProgress(path, loadLabel, store, [])
  ...
  addLayer(map, healthcareFacilitiesWithCapacities, store, beforeId) {
